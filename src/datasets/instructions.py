...
def get_template(task_name, t=1):
    if t == 1:
        if task_name == "sst2" or task_name == "imdb":
            ...
            return {
                0: {
                    "example_instruction": "\"<X>\" The citation intent is method.",
                    "prompting_instruction": "<E>\"<X>\" The citation intent is method.",
                },
                1: {
                    "example_instruction": "\"<X>\" The citation intent is background.",
                    "prompting_instruction": "<E>\"<X>\" The citation intent is background.",
                },
                2: {
                    "example_instruction": "\"<X>\" The citation intent is result.",
                    "prompting_instruction": "<E>\"<X>\" The citation intent is result.",
                }
            }
        elif task_name == "scinli":
            return {
                0: {
                    "example_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is reasoning.",
                    "prompting_instruction": "<E>Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is reasoning.",
                },
                1: {
                    "example_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is entailment.",
                    "prompting_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is entailment.",
                },
                2: {
                    "example_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is contrasting.",
                    "prompting_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is contrasting.",
                },
                3: {
                    "example_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is neutral.",
                    "prompting_instruction": "Sentence1: \"<X>\"Sentence2: \"<C>\" The relation is neutral.",
                }
            }
        elif task_name == "sst5":
            return {
