...
def get_mapping_token0(task_name):
    ...
    if task_name == 'scicite':
        return scicite_map_token
    if task_name == 'scinli':
        return scinli_map_token
    if task_name == 'scierc':
        return scierc_map_token
    return None
...
scicite_map_token = {0: "method", 1: "background", 2: "result"}
scinli_map_token = {0: "reasoning", 1: "entailment", 2: "contrasting", 3: "neutral"}
scierc_map_token = {0: "Method", 1: "Task", 2: "Metric", 3: "Material", 4: "OtherScientificTerm", 5: "Generic"}