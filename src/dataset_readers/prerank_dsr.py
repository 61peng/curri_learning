...
from src.dataset_readers.dataset_wrappers.scierc import SciERCDatasetWrapper
from src.dataset_readers.dataset_wrappers.scinli import SciciteDatasetWrapper
...
class PrerankDatasetReader(torch.utils.data.Dataset):
    ...
    def __init__(self, task_name, field, dataset_path=None, dataset_split=None,
        ...
        #                                                       ds_size=ds_size)
        self.dataset_wrapper = SciERCDatasetWrapper(dataset_path=dataset_path,
                                                    dataset_split=dataset_split,
                                                    ds_size=ds_size)
        # self.dataset_wrapper = SciciteDatasetWrapper(dataset_path=dataset_path,
        #                                             dataset_split=dataset_split,
        #                                             ds_size=ds_size)
